...
Usage:
    ...
    --category    - arXiv category (hep-th). Default: hep-th.
...
def build_html(json_path: str, output_path: str, date_display: str, category: str = "hep-th") -> None:
    """Read JSON, build HTML, write to output_path."""
    json_path = os.path.expanduser(json_path)
    output_path = os.path.expanduser(output_path)
    meta = CATEGORY_META.get(category, CATEGORY_META["hep-th"])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--latest", type=str, default=None,
                        help="If set, also copy to this path (e.g. hep-th-latest.html)")

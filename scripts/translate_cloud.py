...
def build_prompt(category: str) -> str:
    ...
    info = CATEGORY_PROMPTS.get(category, CATEGORY_PROMPTS["hep-th"])
...
RETRY_ABBR = "QFT, SUSY, CFT, AdS/CFT, EFT, RG, SM, BSM, SUGRA, TQFT, LIGO, GW, BH, GR, QPO, ISCO, FLRW, ADM, TOV, PBH, EHT, SKA, LISA, EGB"
...
def translate_papers(json_path, api_key, base_url, model, category="hep-th"):
    """
...
def main():
    ...
    parser.add_argument("--category", default="hep-th",
                        choices=["hep-th"],
                        help="arXiv category (default: hep-th)")
